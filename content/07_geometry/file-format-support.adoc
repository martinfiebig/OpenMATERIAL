...
+
This setup differs from how coordinate systems are defined in {THIS_STANDARD}, see section xref:07_geometry/general.adoc#_coordinate_systems[section 7.2.2, "Coordinate systems"].
