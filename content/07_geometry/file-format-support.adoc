...
+
This setup differs from how coordinate systems are defined in {THIS_STANDARD}, see section xref:07_geometry/general.adoc#_coordinate_systems[Coordinate systems].
