...
The vehicle's 3D geometry is structured according to the node structure defined in xref:../07_geometry/object-vehicle/vehicle-index.adoc#_model_structure[].
...
see xref:../07_geometry/general.adoc#_local_coordinate_system[].
