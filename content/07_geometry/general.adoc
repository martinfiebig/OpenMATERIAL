...
* World coordinate system, see <<World coordinate system, section World coordinate system>>
* Local coordinate system, see <<Local coordinate system, section Local coordinate system>>
