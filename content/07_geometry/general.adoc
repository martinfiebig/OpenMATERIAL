...
Besides reference coordinate frames, _3D assets_ may incorporate other local coordinate frames, see section xref:../07_geometry/object-classes-introduction.adoc[section 7.3.1, "Object classes introduction"].
