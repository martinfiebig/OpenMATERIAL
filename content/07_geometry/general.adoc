...
* World coordinate system, see section <<World coordinate system, World coordinate system>>
* Local coordinate system, see section <<Local coordinate system, Local coordinate system>>
...
Besides reference coordinate frames, _3D assets_ may incorporate other local coordinate frames, see section xref:../07_geometry/object-classes-introduction.adoc[Object classes introduction].
