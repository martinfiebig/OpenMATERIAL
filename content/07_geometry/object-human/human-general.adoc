...
The human 3D geometry is generically structured into the node structure and skeleton (also often called armature) defined in the xref:../07_geometry/object-human/human-index.adoc#_model_structure[section 7.3.3.3, "Model structure"].
