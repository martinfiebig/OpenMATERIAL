...
include::object-vehicle/vehicle-general.adoc[leveloffset=+2
include::object-vehicle/vehicle-structure.adoc[leveloffset=+2]
include::object-vehicle/vehicle-structure-notes.adoc[leveloffset=+2]
