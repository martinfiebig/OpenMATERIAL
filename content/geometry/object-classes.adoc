...
include::object-vehicle/vehicle-index.adoc[leveloffset=+2]
include::object-human/human-index.adoc[leveloffset=+2]
include::object-road-network/road-index.adoc[leveloffset=+2]