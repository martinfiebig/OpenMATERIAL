...
Unless stated otherwise, all numeric valu es within {THIS_STANDARD} are in SI units. <<tab-quantities-units>> lists the units and dimensions:
...
Besides reference coordinate frames, _3D assets_ may incorporate other local coordinate frames, see xref:../geometry/object-classes.adoc[Object classes].
