...
** xref:geometry/Introduction.adoc[leveloffset=+2]
** xref:geometry/General.adoc[leveloffset=+2]
** xref:geometry/object-classes.adoc[leveloffset=+2]
** xref:geometry/File_format_support.adoc[leveloffset=+2]
** xref:geometry/Metadata.adoc[leveloffset=+2]
** xref:geometry/Performance.adoc[leveloffset=+2]

include::material/general-structure-index.adoc[leveloffset=+1]

** xref:material/Introduction.adoc[leveloffset=+2]
** xref:material/Fileformat.adoc[leveloffset=+2]
** xref:material/Metadata.adoc[leveloffset=+2]
** xref:material/Material-parameters.adoc[leveloffset=+2]
