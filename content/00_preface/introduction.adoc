...
A list of use cases examples can be found in the xref:06_use_cases/use-cases.adoc[], each highlighting its relevance to the material chapter, the geometry chapter, or both.
...
* xref:08_material/material-emp-schema.adoc[]
* xref:08_material/material-optical-schema.adoc[]
* xref:08_material/material-brdf-schema.adoc[]
* xref:08_material/material-reflectance-schema.adoc[]
...
{THIS_STANDARD} asset files and 3D objects defined in xref:07_geometry/introduction.adoc[] act as a connecting link between {THIS_STANDARD} and the ASAM OpenX ecosystem.
...
The transformation of reference frames between these ASAM standards is described in xref:07_geometry/general.adoc#_local_coordinate_system[].
