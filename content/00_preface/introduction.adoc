...
3D objects defined in the 07_geometry/introduction.adoc[Geometry] chapter act as a connecting link between {THIS_STANDARD} and the following ASAM standards:
