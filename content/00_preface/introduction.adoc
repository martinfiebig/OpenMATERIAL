...
{THIS_STANDARD} asset files and 3D objects, as defined in xref:07_geometry/introduction.adoc[], act as a connecting link between {THIS_STANDARD} and the ASAM OpenX ecosystem.
...
The transformation of reference frames between these ASAM standards is described in the section xref:07_geometry/general.adoc#_local_coordinate_system[Geometry - Local coordinate system].
