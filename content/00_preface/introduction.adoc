...
* Bidirectional reflectance distribution functions (BRDFs), xref:08_material/material-brdf-schema.adoc[]
* Reflectance table, xref:08_material/material-reflectance-schema.adoc[]
...
{THIS_STANDARD} asset files and 3D objects, as defined in xref:07_geometry/introduction.adoc[Section 7, "Geometry"], act as a connecting link between {THIS_STANDARD} and the ASAM OpenX ecosystem.
...
The transformation of reference frames between these ASAM standards is described in the section xref:07_geometry/general.adoc#_local_coordinate_system[Section 7.2.2.2, "Local coordinate system"].
